...
<p align="center">
  Execute scripts, commands &amp; PSADT deployments on Azure <strong>Windows</strong> VMs at scale — no RDP required.<br/>
  <a href="../../releases"><strong>Download the latest release</strong></a>
</p>
...
>
> ⚠️ **No warranty.** Provided free of charge, **as-is, without warranty of any kind**. Every execution runs as SYSTEM on the target VMs — you are responsible for what you run and where. Test against non-production VMs first.
>
